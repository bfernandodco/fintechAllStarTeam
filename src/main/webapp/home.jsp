...
<body class="bg-light">
    ...
    <div class="d-flex justify-content-around px-5 gap-3">
        ...
        <div class="modal" id="modalLancamento" tabindex="-1" aria-labelledby="modalLancamentoLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-primary" id="modalLancamentoLabel">Novo Lançamento</h4>
        ...
        <div class="modal" id="modalInvestimento" tabindex="-1" aria-labelledby="modalInvestimentoLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-primary" id="modalInvestimentoLabel">Novo Investimento</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label for="nomeAplicacao" class="form-label">Nome da Aplicação</label>
                                <input type="text" class="form-control" id="nomeAplicacao">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipoInvestimento">
                            ...
                            <div class="mb-3">
                                <label for="valorInvestimento" class="form-label">Valor do investimento</label>
                                <input type="text" class="form-control" id="valorInvestimento">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="vinculoInvestimentoObjetivo">
                                <label class="form-check-label" for="vinculoInvestimentoObjetivo">Vincular este lançamento a um objetivo</label>
                            </div>
                            <div class="mb-3">
    ...
    <div class="modal" id="modalObjetivo" tabindex="-1" aria-labelledby="modalObjetivoLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-primary" id="modalObjetivoLabel">Novo Objetivo</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="nomeObjetivo" class="form-label">Nome do Objetivo</label>
                            <input type="text" class="form-control" id="nomeObjetivo">
                        </div>
                        <div class="mb-3">
                            <label for="dataVencimentoObjetivo" class="form-label">Data de Vencimento</label>
                            <input type="date" class="form-control" id="dataVencimentoObjetivo">
                        </div>
                        <div class="mb-3">
                            <label for="valorObjetivo" class="form-label">Valor do Objetivo</label>
                            <input type="text" class="form-control" id="valorObjetivo">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="vinculoObjetivoObjetivo">
                            <label class="form-check-label" for="vinculoObjetivoObjetivo">Vincular este objetivo a um investimento</label>
                        </div>
                        <div class="mb-3">
