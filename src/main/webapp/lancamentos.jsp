<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/css/lancamentos.css" rel="stylesheet">
    ...
    <body class="bg-light">
        ...
        <div class="row p-5">
            <div class=" col-md-6 col-sm-12 col-xs-12 flex-grow-1">
                <div class="boxes d-flex justify-content-between p-5 mb-5 flex-wrap">
                    <div class="d-flex align-items-center tamanho-div">
                        <h4>Saldos</h4>
                    </div>
                    <div>
            ...
            <div class=" col-md-6 col-sm-12 col-xs-12 flex-grow-1">
                <div class="p-5 boxes">
                    ...
                    <form>
                        ...
                        <div class="d-sm-flex flex-sm-column align-items-sm-start mb-3">
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="checkbox"
                                    onclick="toggleObjectiveDropdown()">
                                <label class="form-check-label" for="checkbox">Vincular este lançamento a um
                                    objetivo</label>
                            </div>
